...
if("TRUE" STREQUAL "TRUE")
  set(moveit_experimental_SOURCE_PREFIX /home/logan/trial_test_ws/src/moveit/moveit_experimental)
  set(moveit_experimental_DEVEL_PREFIX /home/logan/trial_test_ws/devel/.private/moveit_experimental)
  ...
  set(moveit_experimental_INSTALL_PREFIX /home/logan/trial_test_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/logan/trial_test_ws/src/moveit/moveit_experimental/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_experimental_NUM_DUMMY_TARGETS)
      set(moveit_experimental_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_experimental::wrapped-linker-option${moveit_experimental_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_experimental_NUM_DUMMY_TARGETS "${moveit_experimental_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_experimental::wrapped-linker-option${moveit_experimental_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_experimental_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/logan/trial_test_ws/devel/.private/moveit_experimental/lib;/home/logan/trial_test_ws/devel/lib;/opt/ros/kinetic/lib)
